...
var i_14590 = (self__.level + (1));
while(true){
if((i_14590 <= (new_level + (1)))){
(update[i_14590] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14592 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14592[i]));
} else {
x__$2.forward.push((((i < links_14592.length))?(links_14592[i]):null));
}

if((i < links_14592.length)){
(links_14592[i] = x__$2);
} else {
links_14592.push(x__$2);
}
...
var i_14597 = (0);
while(true){
if((i_14597 <= self__.level)){
var links_14598 = (update[i_14597]).forward;
if((x__$1 === (((i_14597 < links_14598.length))?(links_14598[i_14597]):null))){
(links_14598[i_14597] = (x__$1.forward[i_14597]));

var G__14599 = (i_14597 + (1));
i_14597 = G__14599;
continue;
} else {
var G__14600 = (i_14597 + (1));
i_14597 = G__14600;
continue;
}
} else {
...
var G__14604 = nx;
var G__14605 = (level__$1 - (1));
x = G__14604;
level__$1 = G__14605;
continue;
} else {
var G__14606 = x;
var G__14607 = (level__$1 - (1));
x = G__14606;
level__$1 = G__14607;
continue;
}
