...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11558 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11558(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11565 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11565(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11574 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11574(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11579 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11579(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11593 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11593(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11595 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11595(reader);
}
});
...
var G__11652 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11653 = s.append(c);
c = G__11652;
s = G__11653;
continue;
}
